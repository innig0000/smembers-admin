...
const PopupEnroll = () => {
    ...
    return(
        <main className="flex min-h-screen flex-col p-24">
            <Header/>
            <h1 className="flex text-xl font-bold m-3">고객지원 > 팝업 > 등록 </h1>
            <Container>
                <Form className="border-2 rounded-3 p-3 my-4">
                    <div className="grid grid-cols-1 md:grid-cols-10 gap-0">
                        ...
                        <div className="col-span-2 flex flex-row m-3">
                            <span className="text-4xl text-black-50">&#8226;</span>
                            <span className="mt-2">활성화</span>
                            <span className="text-xl ml-auto text-black-50 mt-2">&#8226;</span>
                            <span className="mt-2">비활성화</span>
                        </div>
                        <div className="col-span-7 flex flex-row m-3">
                        </div>
                        <div className="col-span-1 flex flex-col m-1">
                            <label className="text-lg font-bold mb-1 text-center mt-3">
                                제목
